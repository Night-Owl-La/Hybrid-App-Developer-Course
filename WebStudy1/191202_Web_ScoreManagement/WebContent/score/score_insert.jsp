	...
	<div>
		<form class="" action="insert.do" method="post">
			...
			<table class="table table-bordered table-hover" style="width: 300px;">
				<caption>
					<h1 style="text-align: center;">::: 성적 입력 :::</h1>
				</caption>
				<tr>
					<th>이름</th>
				...
				<tr>
					<th>국어</th>
					<td><input type="number" name="kor" value=""></td>
				</tr>
				<tr>
					<th>영어</th>
				...
				<tr>
					<th>수학</th>
					<td><input type="number" name="mat" value=""></td>
				</tr>

				<tr>
					<td colspan="2" align="center"><input type="button" name=""
						value="입력" onclick="send(this.form);" class="btn btn-success"> <input
						type="button" name="" value="취소" onclick="location.href='list.do'"
