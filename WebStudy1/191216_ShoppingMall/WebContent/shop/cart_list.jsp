...
<body>
	<table align="center" width="600" border="1"
		...
		<tr align="center">
			<td>p111</td>
			<td>PC</td>
			<td>단가:500<br> <font color="red"> 세일가격:<b>200</b>
			</font>
			</td>
			<td>
				<!-- 수량 조정 폼 -->
				<form action="editQuant.jsp" method="post">
					<input type="hidden" name="p_num" value=""> <input name="q"
						size="4" align="center" value=""> <input type="submit"
						value="수정">
				</form>
			</td>
			<td>1000</td>
			<td><input type="button" value="삭제"
				...
				onclick="location.href='delProduct.jsp?p_num='"></td>
		</tr>
