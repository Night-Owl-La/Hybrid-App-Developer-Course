				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							<div>미리보기</div>
							<img id="preview_p_image_s" src="${ pageContext.request.contextPath }/images/${ vo.p_image_s }" style="width: 150px;">
						</td>
					...
					<tr>
						...
						<td>
							...
							<div>미리보기</div>
							<img id="preview_p_image_l" src="${ pageContext.request.contextPath }/images/${ vo.p_image_l }" style="width: 150px;">
						</td>
					</tr>
