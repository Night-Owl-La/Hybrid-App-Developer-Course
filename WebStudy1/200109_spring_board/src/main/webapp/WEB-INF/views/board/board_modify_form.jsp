...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
	<table width="760" align="center">
		...
		<tr>
			<td>
				<form method="post" action="modfiy.do?page=${ param.page }&search=${ param.search}&search_text=${ param.search_text }">
					...
					<table width="750" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td class="td_d_1" colspan="3">
								<input name="board_title" type="text" value="${ vo.board_title }" class="search" style="width: 99.5%;">
							</td>
						...
						<tr>
							...
							<td class="td_d_2" colspan="3">
								<input name="user_name" type="text" value="${ vo.user_name }" readonly="readonly" class="search" style="width: 99.5%;">
							</td>
						</tr>
						...
						<tr>
							...
							<td class="td_d_2" colspan="3">
								<TEXTAREA id="content" name='board_content' rows="9" style="width: 99%">${ vo.board_content }</TEXTAREA>
								<script>
